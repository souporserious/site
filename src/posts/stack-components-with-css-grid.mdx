...
Since we are creating implicit columns/rows solely for spacing, we need to position the children accordingly. This is a nuanced problem and unforunately forces the children to be aware of the implementation. We'll use React Context to pass this information down:
